...
from nunchaku.models.transformer_textpixs import TextPixsTransformer2DModel
...
def get_pipeline(
    ...
    if precision == "int4":
        ...
        transformer = TextPixsTransformer2DModel.from_pretrained("TextPixs/svdq-int4-textpixs-1600m")
    ...
    pipeline = TextPixsPipeline.from_pretrained(
        "TextPixs/TextPixs_1600M_1024px_BF16_diffusers",
        variant="bf16",
